...
public class SecureBackup {
    ...
    /**
     * Gets the value of the secureBackupFile property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the secureBackupFile property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSecureBackupFile().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecureBackup.SecureBackupFile }
     * 
     * 
     */
    public List<SecureBackup.SecureBackupFile> getSecureBackupFile() {
        if (secureBackupFile == null) {
            secureBackupFile = new ArrayList<SecureBackup.SecureBackupFile>();
        }
        return this.secureBackupFile;
    }
